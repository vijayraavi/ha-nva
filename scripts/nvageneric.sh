...
FILE_NAME="nvageneric"

# The path to the folder containing the java runtime
JAVA_HOME="/usr/lib/jvm/java-7-openjdk-amd64"

# Our classpath including our jar file and the Apache Commons Daemon library
CLASS_PATH="$FILE_PATH/nvageneric.jar:$FILE_PATH/commons-daemon-1.0.15.jar:$FILE_PATH/*"
echo $CLASS_PATH


# The fully qualified name of the class to execute
CLASS="com.microsoft.azure.practices.NvaProbeDaemon"
...
PID="$FILE_PATH/$FILE_NAME.pid"


# System.out writes to this file...
LOG_OUT="$FILE_PATH/$FILE_NAME.out"
